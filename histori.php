...
<body>
  ...
  <div class="container mt-5">
    <div class="row mb-4 pt-4">
      <div class="col">
        <div class="fontKerasBesar">Histori tontonan anda</div>
      </div>
    </div>
  </div>
  <?php
    $id_pengguna=$_SESSION["id_pengguna"];
                    ...
                    FROM postingans inner join kelass on kelass.id_kelas=postingans.id_kelas inner join menontons on menontons.id_postingan=postingans.id_postingan WHERE 
                    menontons.id_pengguna = '$id_pengguna' 
                    order by menontons.id_menonton desc limit 10");
